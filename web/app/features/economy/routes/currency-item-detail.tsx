...
export function meta({ loaderData, matches }: Route.MetaArgs) {
  ...
  return createPageMeta({
    title,
    description: `View ${itemTitle} price history, currency value trends, and Path of Exile 2 market data for ${context}.`,
  });
}
...
export default function CurrencyItemDetail({
  params,
  loaderData,
}: Route.ComponentProps) {
  const routeKind = "currencies";
