...
SELECT cesp.currency_exchange_snapshot_pair_id AS currency_exchange_snapshot_pair_id,
       ...
       ci1.base_item_type_id AS c1_base_item_type_id,
       ci1.text AS c1_text,
       ...
       ci2.base_item_type_id AS c2_base_item_type_id,
       ci2.text AS c2_text,
...
""";
  ...
  private sealed record FlatSnapshotPairRow(
    ...
    int C2ItemId,
    string? C2ApiId,
    string? C2BaseItemTypeId,
    string C2Text,
    string? C2IconUrl,
    int C2CurrencyCategoryId,
    string C2CatLabel,
    string C2CatApiId,
    decimal C1ValueTraded,
    decimal C1RelativePrice,
    decimal C1StockValue,
    long C1VolumeTraded,
    long C1HighestStock,
    decimal C2ValueTraded,
    decimal C2RelativePrice,
    decimal C2StockValue,
    long C2VolumeTraded,
    long C2HighestStock);
